...
//     password: yup.string().typeError("There must be a line").required("Must be completed"),
//     email: yup.string().email("Please enter your email address").required("Must be completed")
//   })

//   const onSubmit = (values, { setSubmitting, setStatus }) => {
//     LoginTc(values.email, values.password, values.rememberMe, setStatus, values.captcha);
//     setSubmitting(false);
//   };
